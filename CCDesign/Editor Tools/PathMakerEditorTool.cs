...
namespace CCTools.CCDesign
{
	public class PathMakerEditorTool : EditorTool
	{
		protected override void OnLeftMouseButtonMove(LevelMapEditor editor, TileLocation location, Keys modifierKeys)
		{
			...
			TileLocation lastLocation = TileLocation.Invalid;
			TileLocation secondLastLocation = TileLocation.Invalid;
			if (!InitializeLocations(editor, out lastLocation, out secondLastLocation))
			{
