...
{
	partial class TrapConnectionsDialog
	{
		/// <summary>
		...
		protected override void Dispose(bool disposing)
		{
			if (disposing)
			{
				...
				if (_owner != null)
				{
					...
					_owner._trapConnectionsDialog = null;
				}
				if (components != null)
					components.Dispose();
			}
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(TrapConnectionsDialog));
            ...
            this.Name = "TrapConnectionsDialog";
            this.ShowInTaskbar = false;
            this.Text = "Trap Connections";
